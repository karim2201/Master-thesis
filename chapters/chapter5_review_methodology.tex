...
The review aims to connect several bodies of literature: general Digital Twin foundations, healthcare and eHealth applications, healthcare-oriented architectures, AI-enabled and hybrid Digital Twin approaches, patient-specific modeling, cardiovascular examples, interoperability, privacy, security, ethics, explainability, and validation. The purpose is not to cover every publication using the term Digital Twin, but to select high-relevance peer-reviewed papers and authoritative sources that support the conceptual and architectural synthesis developed in Chapter 6.
...
\begin{itemize}[leftmargin=*]
    ...
    \item ``artificial intelligence'' AND ``digital twin'' AND healthcare;
    \item ``machine learning'' AND ``digital twin'' AND health;
    \item ``AI-powered digital twin'';
    \item ``generative AI'' AND ``digital twin'' AND healthcare;
    \item ``large language model'' AND ``digital twin'' AND patient;
...
\begin{itemize}[leftmargin=*]
    ...
    \item AI technique used, learning paradigm, model inputs, prediction or inference target, and role of AI inside the Digital Twin lifecycle;
    \item level of personalization, explainability method, uncertainty handling, and validation strategy for AI-enabled components;
...
The extracted information was then classified into thematic groups: Digital Twin foundations, Digital Twins for Health, healthcare architectures, AI-enabled and hybrid Digital Twin approaches, patient-specific frameworks, cardiovascular Digital Twins, and interoperability. Ethics, governance, explainability, and validation were treated as cross-cutting themes.
...
\begin{figure}[H]
    \centering
    \resizebox{0.72\textwidth}{!}{\input{figures/fig_review_workflow}}
