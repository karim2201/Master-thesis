...
Sources were identified through focused keyword searches, publisher and DOI pages, and backward citation tracing from major review papers. Search concepts included ``Digital Twin definition'', ``Digital Twin three dimensions'', ``Digital Twin five dimensions'', ``Digital Model Digital Shadow Digital Twin'', ``Digital Twin for Health'', ``healthcare Digital Twin architecture'', ``human Digital Twin'', ``AI-powered Digital Twin healthcare'', ``cardiovascular Digital Twin'', ``cardiac electrophysiology Digital Twin'', ``heart failure Digital Twin'', ``virtual heart ablation'', and ``patient-specific hemodynamic model''. Additional concepts were used to capture recent hybrid and inverse-modeling work, including ``physics-informed medical Digital Twin'', ``non-invasive medical Digital Twin'', ``real-to-simulation healthcare'', ``self-supervised Digital Twin'', ``cardiac hemodynamic Digital Twin'', ``echocardiography Digital Twin'', ``Windkessel Digital Twin'', and ``inverse physiological modeling''. General Digital Twin definition papers and AI methodology papers were included when their concepts were necessary for healthcare interpretation.
...
For hybrid physiological studies, additional dimensions were extracted: invasive versus non-invasive input data, type of mechanistic physiological model, forward versus inverse modeling, patient-specific latent parameters, use of synthetic simulator data, self-supervised learning, physics-informed learning, surrogate modeling, physiological state reconstruction, identifiability, uncertainty quantification, counterfactual intervention modeling, and validation of hidden physiological states. These dimensions are important because a method may accurately reconstruct an observable variable while still estimating non-unique or physiologically incorrect hidden parameters.

Cardiovascular studies were additionally analyzed by physiological scale, personalization data, calibration method, mechanistic assumptions, clinical comparator, cohort size when reported, and whether the system was a persistent twin or an offline patient-specific model.
