...
\begin{itemize}[leftmargin=*]
    ...
    \item a comparative analysis of Digital Twin definitions, including the classical three-dimensional model, the extended five-dimensional model, and the operational definition adopted in this thesis;
    \item a dual state-of-the-art review covering both general healthcare Digital Twins and cardiovascular Digital Twins;
    \item a comparative analysis of representative eHealth and cardiovascular studies using two landscape tables;
    \item academic synthesis figures covering Digital Twin definitions, Artificial Intelligence roles, healthcare Digital Twin categories, cardiovascular Digital Twin categories, and maturity evidence;
    \item a discussion of interoperability, privacy, security, explainability, validation, and governance as cross-cutting requirements;
    \item a set of literature-derived design implications that connect the Master’s thesis findings to the CardioTwin PFE.
\end{itemize}
