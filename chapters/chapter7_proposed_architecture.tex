...
\begin{figure}[H]
    ...
    \caption{Proposed multi-layer architecture for a Digital Twin-based eHealth system.}
...
\begin{figure}[H]
    ...
    \caption{Security, privacy, and governance concerns around the eHealth Digital Twin.}
...
\begin{figure}[H]
    ...
    \caption{General data flow in a Digital Twin-based eHealth system.}
    \label{fig:data_flow}
\end{figure}
