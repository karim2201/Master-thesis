...
Interoperability is essential for eHealth because patient information may be generated and stored by different systems. Standards such as HL7 and FHIR support the exchange of healthcare information using common formats and resources~\cite{lehne2019interoperability,mandel2016smart,hl7fhir2024}. In a Digital Twin-based eHealth system, interoperability standards help connect data acquisition modules, clinical repositories, virtual models, and decision services.
